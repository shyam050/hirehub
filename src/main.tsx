...
const JobsManagePage = lazy(
  () => import("./pages/dashboard/JobsManagePage.tsx"),
);
...
const ApplicantsPage = lazy(
  () => import("./pages/dashboard/ApplicantsPage.tsx"),
);
const AdminStudentsPage = lazy(
  () => import("./pages/dashboard/AdminStudentsPage.tsx"),
);
const AdminRecruitersPage = lazy(
  () => import("./pages/dashboard/AdminRecruitersPage.tsx"),
);
const AdminCompaniesPage = lazy(
  () => import("./pages/dashboard/AdminCompaniesPage.tsx"),
);
const AdminAllJobsPage = lazy(
  () => import("./pages/dashboard/AdminAllJobsPage.tsx"),
);
const AdminAllApplicationsPage = lazy(
  () => import("./pages/dashboard/AdminAllApplicationsPage.tsx"),
);
const StudentInterviewsPage = lazy(
  () => import("./pages/dashboard/StudentInterviewsPage.tsx"),
);
const RecruiterInterviewsPage = lazy(
  () => import("./pages/dashboard/RecruiterInterviewsPage.tsx"),
);
const ResumeAnalysisPage = lazy(
  () => import("./pages/dashboard/ResumeAnalysisPage.tsx"),
);
const AIInterviewsPage = lazy(
  () => import("./pages/dashboard/AIInterviewsPage.tsx"),
);
const AIInterviewNewPage = lazy(
  () => import("./pages/dashboard/AIInterviewNewPage.tsx"),
);
const AIInterviewSessionPage = lazy(
  () => import("./pages/dashboard/AIInterviewSessionPage.tsx"),
);
const AIInterviewReportPage = lazy(
  () => import("./pages/dashboard/AIInterviewReportPage.tsx"),
);
